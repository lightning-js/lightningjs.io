    ...
    <div class="z-10 relative px-6 lg:px-8">
        ...
        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-900 dark:text-gray-200 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                Lightningjs 3.0 <a href="https://lightningjs.io/v3-docs/blits/introduction.html" target="_blank" class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true" />Read more <span aria-hidden="true">&rarr;</span></a>
            </div>
        </div>
        <div class="text-center">
            ...
            <LinkButton class="mt-10" href="https://lightningjs.io/v3-docs/blits/introduction.html" label="Beta"/>
          </div>
        </div>
      </div>
</template>