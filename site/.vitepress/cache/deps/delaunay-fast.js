...
var require_delaunay = __commonJS({
  "node_modules/delaunay-fast/delaunay.js"(exports, module) {
    var Delaunay;
    (function() {
      "use strict";
      ...
      Delaunay = {
        triangulate: function(vertices, key) {
          ...
          for (i = n; i--; )
            indices[i] = i;
          indices.sort(function(i2, j2) {
            return vertices[j2][0] - vertices[i2][0];
          });
...
export default require_delaunay();
//# sourceMappingURL=delaunay-fast.js.map
